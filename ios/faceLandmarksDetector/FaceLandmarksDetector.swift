...
//import Vision
//
//@objc(FaceLandmarksDetectorPlugin)
//public class FaceLandmarksDetectorPlugin: NSObject, FrameProcessorPluginBase {
//  @objc public static func callback(_ frame: Frame!, withArgs args: [Any]!) -> Any! {
//    guard let imageBuffer = CMSampleBufferGetImageBuffer(frame.buffer) else {
//                return nil
//            }
//            NSLog("FaceLandmarksDetectorPlugin: \(CVPixelBufferGetWidth(imageBuffer)) x \(CVPixelBufferGetHeight(imageBuffer)) Image. Logging \(args.count) parameters:")
//
//            args.forEach { arg in
//                var string = "\(arg)"
...
//                }
//                NSLog("FaceLandmarksDetectorPlugin:   -> \(string) (\(type(of: arg)))")
//            }
//
//            return [
//                "example_str": "Test",
...
public class FaceLandmarksDetectorPlugin: NSObject, FrameProcessorPluginBase {
  ...
  private static func processContours(from face: Face) -> [String:[[String:CGFloat]]] {
       let faceContoursTypes = [
         FaceContourType.face,         FaceContourType.leftEyebrowTop,
